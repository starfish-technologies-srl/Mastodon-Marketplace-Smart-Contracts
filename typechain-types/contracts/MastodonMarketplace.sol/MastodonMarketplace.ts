...
export interface MastodonMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buy"
      | "delistERC1155"
...
export interface MastodonMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): MastodonMarketplace;
  waitForDeployment(): Promise<this>;

  interface: MastodonMarketplaceInterface;
  ...
  buy: TypedContractMethod<
    [listIndex: BigNumberish, token: BigNumberish],
    [void],
    "payable"
  >;
  ...
  delistERC721: TypedContractMethod<
    [listIndex: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  listERC1155: TypedContractMethod<
    [inputOrder: IMastodonMarketplace.InputOrderERC1155Struct],
    [void],
    "nonpayable"
  >;

  listERC721: TypedContractMethod<
    [inputOrder: IMastodonMarketplace.InputOrderERC721Struct],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[listIndex: BigNumberish], [void], "nonpayable">;
  getFunction(
